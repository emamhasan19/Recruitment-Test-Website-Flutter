...
const TextStyle _labelErrorTextStyle = TextStyle(
...
class InputFormField extends StatefulWidget {
  ...
  /// The padding for the input decoration's container. Defaults to 10px
  /// horizontally
  /// and 10px vertically
...
class _InputFormFieldState extends State<InputFormField> {
  ...
  Widget build(BuildContext context) {
    final isOutlinedBorder = widget.borderType == BorderType.outlined;
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: widget.borderType == BorderType.outlined
          ...
          child: SingleChildScrollView(
            child: TextFormField(
              ...
              decoration: InputDecoration(
                isDense: true,
                contentPadding:
                    widget.contentPadding ?? _defaultContentPadding(),
                labelText: widget.labelText,
                labelStyle:
                    isError ? _labelErrorTextStyle : widget.labelTextStyle,
              ...
              validator: widget.validator.isNotNull
                  ...
                  : (String? v) {
                      /// Default validation. Fields can't be empty. If you want
                      /// to disable it
